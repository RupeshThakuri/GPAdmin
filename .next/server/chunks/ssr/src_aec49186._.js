...
const productService = {
    createProduct: async (data, files)=>{
        console.log('Creating product:', data, files);
        return {
            id: Date.now().toString(),
            ...data
        };
    },
    updateProduct: async (id, data, files, deletedIds)=>{
        console.log('Updating product:', id, data, files, deletedIds);
        return {
            id,
            ...data
        };
...
function ProductForm({ initialData, setIsAddOpen }) {
    ...
    const [allImages, setAllImages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialData?.images || []);
    ...
    const [activeImageIndex, setActiveImageIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialData?.primaryImageIndex ?? (initialData?.images?.length ? 0 : null));
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useForm"])({
        resolver: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["zodResolver"])(productFormSchema),
        defaultValues: initialData ? {
            ...
            shipping: {
                ...
                dimensions: initialData.shipping?.dimensions ? {
    ...
    async function onSubmit(data) {
        ...
        try {
            const formData = {
                ...data,
                images: allImages.filter((img)=>!deletedImageIds.includes(img.id || '')),
    ...
    const handleImageUpload = (e)=>{
        if (e.target.files) {
            ...
            // Add to imageFiles state for form submission
            setImageFiles((prev)=>[
                    ...prev,
                    ...filesArray
                ]);
            ...
            // Update allImages state for display
            setAllImages((prev)=>[
                    ...prev,
                    ...newImages
                ]);
            ...
            // Set active image if none is selected
            if (activeImageIndex === null && updatedImages.length > 0) {
                setActiveImageIndex(allImages.length); // Index of first new image
            }
        }
    };
    // Set active image
    ...
    const removeImage = (index)=>{
        ...
        // If it's an existing image (has ID), add to deleted images
        if (imageToRemove?.id) {
            setDeletedImageIds([
                ...deletedImageIds,
                imageToRemove.id
        ...
        // If it's a new image, remove from imageFiles
        if (imageToRemove?.isNew) {
            const newImageIndex = allImages.slice(0, index).filter((img)=>img.isNew).length;
        ...
        // Update form values
        form.setValue("images", newAllImages);
        // Update active image index
        if (activeImageIndex === index) {
            const newIndex = newAllImages.length > 0 ? 0 : null;
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TabsContent"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        allImages.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-6 grid grid-cols-2 md:grid-cols-4 gap-4",
                                            children: allImages.map((image, index)=>{
                                                const fullImageUrl = image.isNew ? image.url : getFullImageUrl(image.url);
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                ...
                                                                onError: (e)=>{
                                                                    ...
                                                                    target.src = "https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=150&h=150";
                                                                }
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/Products/product-form.tsx",
                                                                lineNumber: 1385,
...
//# sourceMappingURL=src_aec49186._.js.map