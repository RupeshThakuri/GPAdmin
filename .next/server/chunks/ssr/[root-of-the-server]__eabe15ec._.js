...
function ProductForm({ initialData, setIsAddOpen }) {
    ...
    const [imagesModified, setImagesModified] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    async function onSubmit(data) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].log("Submitting form with data:", data);
        ...
        try {
            ...
            let response;
            if (initialData?.id) {
                __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].log("Updating existing product with ID:", initialData.id);
                // For updates, only pass imageFiles and deletedImageIds if images were actually modified
                const imagesToPass = imagesModified ? imageFiles : [];
                const deletedIdsToPass = imagesModified ? deletedImageIds : [];
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["productService"].updateProduct(initialData.id, formData, imagesToPass, deletedIdsToPass);
            } else {
                __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].log("Creating new product");
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].error("Error submitting product:", error);
    ...
    const setActiveImage = (index)=>{
        ...
        // Only mark as modified if we're editing and changing the primary image
        if (initialData?.id && initialData.primaryImageIndex !== index) {
    ...
    const removeImage = (index)=>{
        ...
        if (currentImages[index] && currentImages[index].id) {
            ...
            setImagesModified(true) // Mark images as modified when deleting existing images
            ;
        }
    ...
    async function addNewCategory(e) {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].error("Error creating category:", error);
            toast({
                title: "Error",
                                    ...
                                    children: [
                                        ...
                                        imagePreviewUrls.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: imagePreviewUrls.map((url, index)=>{
                                                ...
                                                __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].log(fullImageUrl);
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eabe15ec._.js.map