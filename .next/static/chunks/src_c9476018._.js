...
function ProductForm({ initialData, setIsAddOpen }) {
    ...
    const getFullImageUrl = (imageUrl)=>{
        ...
        console.log("Images after adding url", imageUrl);
    ...
    //Chaning the images url for upload
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductForm.useEffect": ()=>{
    ...
    async function onSubmit(data) {
        ...
        try {
            const finalImageUrls = tempUrl.map((originalUrl, index)=>{
                const currentPreviewUrl = imagePreviewUrls[index];
                if (currentPreviewUrl && currentPreviewUrl.startsWith("blob:")) {
                    return currentPreviewUrl;
                }
                return originalUrl;
            });
            // Create images array with final URLs for submission
            ...
            const formData = {
                ...
                // Use finalImages for submission
                images: finalImages
            };
            let response;
            if (initialData?.id) {
...
function ProductsTable() {
    ...
    function SectionUpdateDialog({ product, open, onOpenChange }) {
        ...
        // Load previously selected section from localStorage on dialog open
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "ProductsTable.SectionUpdateDialog.useEffect": ()=>{
                if (open && product) {
                    const savedSections = localStorage.getItem("productSections");
                    if (savedSections) {
                        const sections = JSON.parse(savedSections);
                        const productSection = sections[product.id];
                        if (productSection) {
                            setSelectedSection(productSection);
                        }
                    }
                }
            }
        ...
        const handleSave = ()=>{
            if (!product) return;
            // Get existing sections or initialize empty object
            const savedSections = localStorage.getItem("productSections");
            const sections = savedSections ? JSON.parse(savedSections) : {};
            // Update the section for this product
            sections[product.id] = selectedSection;
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                    value: "huge-discounts",
                                                    children: "Huge Discounts"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/Products/product-table.tsx",
                                                    lineNumber: 775,
                                                    columnNumber: 19
    ...
    _s1(SectionUpdateDialog, "ATHbdLrC6996iUieVyOBP/8oUDg=");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            ...
            children: [
                ...
                selectedProduct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SectionUpdateDialog, {
                            product: selectedProduct,
...
//# sourceMappingURL=src_c9476018._.js.map