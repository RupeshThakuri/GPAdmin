...
"[project]/src/components/Products/edit-products.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditProductForm({ initialData, onClose }) {
    ...
    const [imagePreviewUrls, setImagePreviewUrls] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialData?.images?.map({
        "EditProductForm.useState": (img)=>img.url
    }["EditProductForm.useState"]) || []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditProductForm.useEffect": ()=>{
            const fetchData = {
                "EditProductForm.useEffect.fetchData": async ()=>{
                    try {
            ...
            }["EditProductForm.useEffect.fetchData"];
            fetchData();
        }
    }["EditProductForm.useEffect"], [
        toast
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        ...
        defaultValues: {
            ...
            categories: initialData.categories?.map({
                "EditProductForm.useForm[form]": (cat)=>cat.toString()
            }["EditProductForm.useForm[form]"]) || [],
            ...
            images: initialData.images?.map({
                "EditProductForm.useForm[form]": (img)=>({
                        url: img.url,
                        alt: img.alt || "",
    ...
    async function onSubmit(data) {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productService"].updateProduct(initialData.id, formData, imageFiles, deletedImageIds);
            if (!response) {
...
_s(EditProductForm, "nolctY1sncjUUGUHin1moyEjTc8=", false, function() {
    return [
...
//# sourceMappingURL=src_components_Products_edit-products_tsx_689d4c6d._.js.map